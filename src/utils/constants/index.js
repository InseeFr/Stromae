...
export const QUESTIONNAIRE_EXAMPLE_URL = q =>
  `${process.env.PUBLIC_URL}/static/questionnaire/${q}/form.json`;
export const METADATA_EXAMPLE_URL = q =>
  `${process.env.PUBLIC_URL}/static/questionnaire/${q}/metadata.json`;
export const DATA_EXAMPLE_URL = q =>
  `${process.env.PUBLIC_URL}/static/questionnaire/${q}/data.json`;

export const DEFAULT_DATA_URL = DATA_EXAMPLE_URL(DEFAULT);
export const DEFAULT_METADATA_URL = METADATA_EXAMPLE_URL(DEFAULT);
export const FULL_METADATA_URL = `${process.env.PUBLIC_URL}/static/metadata/full.json`;
