  ...
  legalTermsDetails: {
    fr: {
      value: [
        `(if nvl(cast(Enq_TestNonLabellise, boolean), false)
				then 
				"Cette enquête non obligatoire relève de l'exercice des missions de service public dont est investi l'Insee (articles 4, 5 et 5 bis du règlement 223/2009 relatif aux statistiques européennes, article 1 de la [loi n° 51-711 du 7 juin 1951](" || Loi_statistique ||") sur l'obligation, la coordination et le secret en matière de statistiques, décret du 14 juin 1946 organisant l'Insee)."
				else
    ...
    en: {
      value: [
        `(if nvl(cast(Enq_TestNonLabellise, boolean), false)
				then 
				"This non-compulsory survey is part of INSEE's public service remit (Articles 4, 5 and 5a of Regulation 223/2009 on European statistics, Article 1 of [Law 51-711 of 7 June 1951](" || Loi_statistique ||") on the obligation, coordination and secrecy of statistics, Decree of 14 June 1946 organising INSEE)."
				else
