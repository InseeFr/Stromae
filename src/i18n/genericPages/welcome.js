const welcomeHousehold = {
  ...
  legalTermsDetails: {
    fr: {
      value: [
        `"Vu l'avis favorable du Conseil national de l'information statistique, cette enquête" || (if cast(Enq_CaractereObligatoire, boolean) then ", reconnue d’intérêt général" || (if cast(Enq_QualiteStatistique, boolean) then " et de qualité statistique" else "") || ", est obligatoire" else " est reconnue d'intérêt général" || (if cast(Enq_QualiteStatistique, boolean) then " et de qualité statistique" else "") || "sans avoir de caractère obligatoire") || ", en application de la [loi n° 51-711 du 7 juin 1951](" || Loi_statistique ||") sur l'obligation, la coordination et le secret en matière de statistiques."`,
    ...
    en: {
      value: [
        `"In view of the favourable opinion of the National Council for Statistical Information, this survey" || (if cast(Enq_CaractereObligatoire, boolean) then ", recognized as being of general interest" || (if cast(Enq_QualiteStatistique, boolean) then " and of statistical quality" else "") || ", is mandatory" else " is recognized as being of general interest" || (if cast(Enq_QualiteStatistique, boolean) then " and of statistical quality" else "") ||  " without being mandatory") || ", in application of [Law n° 51-711 of 7 June 1951](" || Loi_statistique ||") on the obligation, coordination and secrecy in matters of statistics."`,
