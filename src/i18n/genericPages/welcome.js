  ...
  legalTermsDetails: {
    fr: {
      value: [
        ...
        `"Visa n°" || cast(Enq_AnneeVisa, string) || " du Ministre " || Enq_MinistereTutelle || ", valable pour l'année " || cast(Enq_AnneeVisa, string) || " - Arrêté en " || (if cast(Enq_ParutionJo,boolean) then (" date du " || Enq_DateParutionJo) else "cours de parution") || "."`,
