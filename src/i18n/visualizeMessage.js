...
const visualizeMessage = {
  ...
  accordionHelperBody: {
    fr: `Chacun des 3 choix est optionnel, si aucune valeur n'est renseignée, les valeurs par défaut sont appliquées. \n\n Des exemples de json sont disponible ici : \n - [questionnaire](${QUESTIONNAIRE_EXAMPLE_URL}) \n - [metadonnées](${METADATA_EXAMPLE_URL}) \n - [données](${DATA_EXAMPLE_URL})`,
    en: `Each of the 3 choices is optional, if no value is entered, the default values are applied. \n\n Examples of json are available here : \n - [questionnaire](${QUESTIONNAIRE_EXAMPLE_URL}) \n - [metadata](${METADATA_EXAMPLE_URL}) \n - [data](${DATA_EXAMPLE_URL})`,
  },
};
