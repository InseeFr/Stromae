...
export function WelcomeQuestions(props: { welcome: WelcomeType }) {
    ...
    return (
        <div className={fr.cx('fr-accordions-group')}>
            ...
            {props.welcome.Enq_Faq_QuestionsAdditionnelles && props.welcome.Enq_Faq_QuestionsAdditionnelles.map((questionAdditionnelle: { question: string, contenu: string }, index: number) =>
