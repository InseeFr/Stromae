    ...
    return (
        <div className={fr.cx('fr-accordions-group')}>
            <Accordion label="Quel est le cadre légal de l'enquête?">
                ...
                <p>Les réponses à ce questionnaire sont protégées par le secret statistique et destinées à {props.welcome.Enq_RespOperationnel}. Le <a title='Règlement général 2016/679 du 27 avril 2016 sur la protection des données (RGPD)' href={props.welcome.Loi_rgpd} target='_blank' rel='noopener'>règlement général 2016/679 du 27 avril 2016 sur la protection des données (RGPD)</a> ainsi que la <a title="loi n° 78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés - ouvre une nouvelle fenêtre" href={props.welcome.Loi_informatique} target='_blank' rel='noopener'>loi n° 78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés</a> s'appliquent à la présente enquête. Ils garantissent aux personnes concernées un droit d'accès, de limitation ou de rectification pour les données les concernant. Ce droit peut être exercé auprès de {props.welcome.Enq_RespTraitement}.</p>
            </Accordion>
