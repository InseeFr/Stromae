...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="xhtml:body">
        <xsl:variable name="numero-version" select="p:property('numero-version')"/>
        <xsl:variable name="url-portail" select="p:property('url-portail')"/>
        <xsl:copy>
            <xsl:apply-templates select="@* | node()"/>
        </xsl:copy>
                ...
                <xhtml:ul>
                    ...
                    <xhtml:li class="a2">
                        ...
                        <xsl:element name="xhtml:a">
                            ...
                            <xsl:text>Conditions générales d'utilisation</xsl:text>
                        </xsl:element>
                    </xhtml:li>
                    <xhtml:li class="a3">
                        <!--<xhtml:a
                    ...
                    <xhtml:li class="a4">
                        ...
                        <xsl:element name="xhtml:a">
                            ...
                            <xsl:value-of select="'Mentions légales et crédits'"/>
                        </xsl:element>
                    </xhtml:li>
                    <xhtml:li class="a5">
                        <!--<xhtml:a
                        ...
                        <xsl:element name="xhtml:a">
                            ...
                            <xsl:value-of select="'Cadre juridique'"/>
                        </xsl:element>
                    </xhtml:li>
                    <xhtml:li class="a6">
